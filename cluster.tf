module "network" {
  source = "git::https://git@github.com/FairwindsOps/terraform-gcp-vpc-native.git//default?ref=default-v2.1.0"
...
module "cluster" {
  source                           = "git::https://git@github.com/FairwindsOps/terraform-gke.git//vpc-native?ref=vpc-native-v1.2.0"
  region                           = "us-central1"
  name                             = "gke-example"
...
module "node_pool" {
  source             = "git::https://git@github.com/FairwindsOps/terraform-gke//node_pool?ref=node-pool-v3.0.0"
